...
exitBtn.addEventListener("click", () => { ipcRenderer.send('menuBtnAction', "exit") })

// minimize
const minimizeBtn = document.querySelector(".minimize-btn")
minimizeBtn.addEventListener("click", () => { ipcRenderer.send('menuBtnAction', "minimize") })

// podium
const podiumBtn = document.querySelector(".podium-btn")
podiumBtn.addEventListener("click", () => { ipcRenderer.send('menuBtnAction', "podium") })

// region select
const regionSelect = document.querySelector("#region")
regionSelect.addEventListener("change", () => { ipcRenderer.send('updateRegion', regionSelect.value) })

// sort options
const sortSelect = document.querySelector("#sortOptions")
sortSelect.addEventListener("change", () => { onSortOptionChange() })
